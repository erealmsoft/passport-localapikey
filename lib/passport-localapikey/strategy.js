 ...
 *
 * The remote api key authentication strategy authenticates requests based on the
...
function Strategy(options, verify) {
  ...
  if (!verify) throw new Error('remote authentication strategy requires a verify function');

  this._apiKeyField = options.apiKeyField || 'apikey';
  this._apiKeyHeader = options.apiKeyHeader || 'apikey';

  passport.Strategy.call(this);
  this.name = 'remoteapikey';
  this._verify = verify;
